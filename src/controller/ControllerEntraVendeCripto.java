...
import view.EntraVendeCripto;
import view.VendeCripto;


public class ControllerEntraVendeCripto {
    
    private EntraVendeCripto view;

    public ControllerEntraVendeCripto(EntraVendeCripto view) {
        this.view = view;
    }

    public EntraVendeCripto getView() {
        return view;
    }

    public void setView(EntraVendeCripto view) {
        this.view = view;
    }

    public void entraVendeCripto() {
        ...
        try (Connection conn = conexao.getConnection()) {
            ...
            if (res.next()) {
                ...
                if (cot.next()) {
                    ...
                    VendeCripto viewVendeCripto = new VendeCripto(new Investidor(carteira, cotacao, nome, cpf, senha));

                    viewVendeCripto.setVisible(true);
